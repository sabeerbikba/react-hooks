...
// Define types for reducer and action
...
/* Usage example: *
import useLocalStorageReducer from '../hooks.ts/useLocalStorageReducer'; // Import the custom hook
import './App.css';
...
function App() {
    ...
    const [count, dispatch] = useLocalStorageReducer<number, string>('count2', reducer, 25);
